...
<style lang="less">
  ...
  @tab-bar-active-color: @tab-text-color;
  @tab-text-default-color:#666;
  @tab-text-active-color:#161616;
  @tab-text-bottom-color:@tab-text-color;
  ...
  .vux-tab .vux-tab-item.vux-tab-selected {
    ...
    border-bottom: 3px solid @tab-text-bottom-color;
  }
  .vux-tab-bar-top {
    .vux-tab .vux-tab-item {
    ...
    .vux-tab .vux-tab-item.vux-tab-selected {
      border-bottom: none;
      border-top: 3px solid @tab-text-bottom-color;
    }
  }
  ...
  .vux-tab-bar-inner {
    display: block;
    background-color: @tab-text-bottom-color;
    margin: auto;
    height: 100%;
